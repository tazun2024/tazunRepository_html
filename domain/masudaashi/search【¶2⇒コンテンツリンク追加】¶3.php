  ...
  $bachuTmp = @$_REQUEST['BACHU_TMP'] ?: '';
      ...
      //$meigaraNm = getMeigaraNm($targetCode);
        ...
        if ( $targetCode <> '1001' and
             ...
             $targetCode <> '1052' and
             $targetCode <> '1081'     ) {
            echo     "&nbsp;<a href=https://kabuyoho.jp/sp/reportTarget?bcode=".$targetCode." onclick=\"window.open('https://kabuyoho.jp/sp/reportTarget?bcode=".$targetCode."', 'kabupro','width=640,height=640,noopener'); return false;\"><font size=-1>論理株価 ──株予報Pro</font></a>";
        } else {
            echo     "&nbsp;";
        }
        echo     "</TD>";

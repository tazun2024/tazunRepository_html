...
echo "<div class='green'>";
  ...
  $bachuTmp = @$_REQUEST['BACHU_TMP'] ?: '';
      ...
      //$meigaraNm = getMeigaraNm($targetCode);
        ...
        echo     "</TD>";
        echo     "<TD>";
        echo     "&nbsp;<a href=https://cmx.boy.jp/html/domain/marketInfo/marketInfo.php?TARGET_CODE=".$targetCode."><font size=-1>marketInfo</font></a>";
        echo     "&nbsp;<a href=https://finance.yahoo.co.jp/quote/".$targetCode."/chart><font size=-1>Yahooチャート</font></a>";
        echo     "<br>";
        echo     "&nbsp;<a href=https://cmx.boy.jp/html/BillionStuffRevolutionStg/View/indexBSR.php?MEIGARA_CD=".$targetCode."><font size=-1>BillionStuffRevolution</font></a><br>";
        if ( $targetCode <> '1001' and
             ...
             $targetCode <> '1052' and
             $targetCode <> '1081'     ) {
            echo     "&nbsp;<a href=https://kabuyoho.jp/sp/reportTarget?bcode=".$targetCode." onclick=\"window.open('https://kabuyoho.jp/sp/reportTarget?bcode=".$targetCode."', 'kabupro','width=640,height=480,noopener'); return false;\"><font size=-1>論理株価 ──株予報Pro</font></a>";
        } else {
            echo     "&nbsp;";
        }
        echo     "</TD>";

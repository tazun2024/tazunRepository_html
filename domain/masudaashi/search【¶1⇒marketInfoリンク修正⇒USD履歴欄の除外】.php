...
echo "<div class='green'>";
  ...
  $bachuTmp = @$_REQUEST['BACHU_TMP'] ?: '';
      ...
      //$meigaraNm = getMeigaraNm($targetCode);
        ...
        echo     "&nbsp;</span><a href=https://cmx.boy.jp/html/domain/marketInfo/marketInfo.php?TARGET_CODE=".$targetCode."><font size=-1>marketInfo</font></a>";
        ...
        if ($sixclrDistribution == '') {
          ...
          if (!isset($_REQUEST['TARGET_YMD'])) {
            ...
            if ($sixclrDistribution == 'N225') {
              ...
              $image = file_get_contents("http://ik1-326-23246.vs.sakura.ne.jp/BillionStuff/%5Eact/MY_MASUDAASHI/_fileWork/sixClrDistributiontarget.gif"."?dummy=".date('Ymdhis'));
            ...
            //echo "&nbsp;<a href='./search.php?SIXCLR_DISTRIBUTION=MOTHERS&TARGET_CD=".$targetCode."'>（マザーズの6色分布図を表示）</a><BR>\n";
              ...
              $image = file_get_contents("http://ik1-326-23246.vs.sakura.ne.jp/BillionStuff/%5Eact/MY_MASUDAASHI/_fileWork/sixClrDistributionMotherstarget.gif"."?dummy=".date('Ymdhis'));

<?php
    ...
    include(APP_ROOT.'COMMON/Cfg/InvestxCfg.php');
            ...
            $myCmxLog->infEcho('>>execute syncroCopyBsSAKURA_ADMINsimuDump');
/*
            $myCmxLog->infEcho("delete from BS_ADMIN where meigara_cd = 'CR_N225M';");
...
****/
                ...
                if (isset($node->childNodes[0])) {
                    ...
                    if ($node->childNodes[0]->nodeValue == 'SM_N225M') {

                        $SQL = "insert into BS_ADMIN values('SM_N225M".                                // meigara_cd

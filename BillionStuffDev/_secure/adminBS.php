...
//
///////////////////////////////
//$contentsArr[] = '<table><tr><td class=nallow><A href=./syncroCopyBsSAKURA_ADMIN.php><img src=/html/_invextX.files/process_icon.png><font size=+1>さくらADMIN（CRONをコピー）（./syncroCopyBsSAKURA_ADMIN.php）</font></A></td></tr></table>';
//$contentsArr[] = '<br><HR align=left width=80% color=silver>';

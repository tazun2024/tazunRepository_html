<?php
    ...
    include(APP_ROOT.'COMMON/Cfg/InvestxCfg.php');
            ...
            //////// //////// //////// ////////
            $url = 'http://ik1-326-23246.vs.sakura.ne.jp/BillionStuff/%5Eact/View/tmp.selectResultBs.php?execQuery='.str_replace(' ', '%20', "select meigara_cd,date,side,value,price from INVESTX_ADMIN where meigara_cd='CR_N225M'&dTimeColumn=date&");
            //////// //////// //////// ////////

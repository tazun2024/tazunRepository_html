<?php
    ...
    include(APP_ROOT.'COMMON/Cfg/InvestxCfg.php');
            ...
            $myCmxLog->infEcho('>>execute syncroCopyFsSAKURA_ADMINsimuDump');
/*
            $myCmxLog->infEcho("delete from BS_ADMIN where meigara_cd = 'CR_N225M';");

            $myFSDao = new BSDao($myCmxLog, INVESTX_NOT_APPLICABLE_VALUE);

            //////// クエリの実行
            $myFSDao->getListTypeRecord("delete from BS_ADMIN where meigara_cd = 'CR_N225M'");
*/
...
*/
      ...
      //////$myFSDao->getListTypeRecord("update BS_ADMIN set value = '".$NY_ELMCT."' where meigara_cd = 'CR_N225M' and side = 'NY_ELMCT';");
